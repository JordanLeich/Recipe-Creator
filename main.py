...
def main():  # sourcery no-metrics
    ...
    with open('ingredients.txt') as file:
        ...
        if 'tortilla' in ingredients_list or 'tortillas' in ingredients_list and 'cheese' in ingredients_list:
            print_green('Cheese Quesadillas\n')
        if 'tortilla' in ingredients_list or 'tortillas' in ingredients_list and 'cheese' in ingredients_list \
                and 'chicken' in ingredients_list:
            print_green('Chicken & Cheese Quesadillas\n')
        if 'tortilla' in ingredients_list or 'tortillas' in ingredients_list and 'cheese' in ingredients_list \
                and 'meat' in ingredients_list or 'hamburger' in ingredients_list:
        ...
        if 'bread' in ingredients_list and 'hotdog' in ingredients_list or 'bun' in ingredients_list:
            print_green('Hotdogs\n')
        if 'meat' in ingredients_list and 'shell' in ingredients_list or 'shells' in \
                ingredients_list:
        ...
        if 'meat' in ingredients_list and 'tomato' in ingredients_list or 'tomatoes' in ingredients_list:
            print_green('Chili\n')
        if 'beans' in ingredients_list and 'meat' in ingredients_list and 'tomato' in ingredients_list or 'tomatoes' \
                in ingredients_list:
            print_green('Chili w/Beans\n')
        if 'potato' in ingredients_list or 'potatoes' in ingredients_list and 'cheese' in ingredients_list and 'meat' \
                in ingredients_list or 'chili' in ingredients_list:
        ...
        if 'dough' in ingredients_list and 'cheese' in ingredients_list and 'sauce' in ingredients_list and 'chicken' \
                in ingredients_list:
            print_green('Pizza w/Chicken\n')
        if 'chip' in ingredients_list or 'chips' in ingredients_list and 'meat' in ingredients_list and 'salsa' \
                in ingredients_list or 'cheese' in ingredients_list:
            print_green('Nachos\n')
        else:
